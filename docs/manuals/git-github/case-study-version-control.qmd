...
Does this look familiar? Then you may understand the value of tracking changes to a project and having a history of previous versions. **You are doing version control!**
...
![Click the higlighted button to see all saved versions or commits of this git project, see .](/images/github-demo-home-highlight.PNG){#fig-2 fig-align="center" width="600"} 
...
![[This is the first version of the project](https://github.com/Drexel-UHC/github-demo/tree/f21587aece8a58b3e2ab3b777bbcfe0a4c26a695), as you can see it is empty.](/images/github-demo-history-initial.PNG){#fig-5 fig-align="center" width="600"} 